...
export function StatCard({ label, value, hint, icon = null, tone = "default", footer = null }) {
  const tones = {
  ...
  return (
    <Card className={cn("flex h-full flex-col border-l-4 p-4", tones[tone] || tones.default)}>
